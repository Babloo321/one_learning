  ...
  return (
    <div className={styles.container}>
      <div className={styles.top}>
        <p className={styles.smHeading}>Privacy Policy</p>
        ...
        <div className={styles.content}>
          ...
          <p>
            ...
            <span style={{ color: 'red' }}>Privacy Policy Generator.</span>
          </p>
        </div>
      </div>

      <div className={styles.interAndDef}>
        ...
        <ul>
          ...
          <li>
            ...
            this Agreement) refers to Onelearning Edusphere Pvt. Ltd., 2163
            wisteria tower gaur saundryam greater noida west 201306.
          </li>
          <li>
          ...
          <li>
            <strong>Personal</strong> Data is any information that relates to an identified or
            identifiable individual.
          </li>
          <li><strong>Service</strong> refers to the Website.</li>
          <li>
            <strong>Service</strong> Provider means any natural or legal person who processes the
          ...
          <li><strong>Third-party</strong> Social Media Service refers to any website or any social network website through which a User can log in or create an account to use the Service.</li>
          <li><strong>Usage</strong> Data refers to data collected automatically, either generated by the use of the Service or from the Service infrastructure itself (for example, the duration of a page visit).</li>
          <li><strong>Website</strong> refers to ONELearning, accessible from <span style={{color:"red"}}>https://onelearning.org.in</span></li>
      ...
      <div className={styles.data}>
        ...
        <ul>
          ...
          <li><strong>Flash Cookies.</strong> Certain features of our Service may use local stored objects (or Flash Cookies) to collect and store information about Your preferences or Your activity on our Service. Flash Cookies are not managed by the same browser settings as those used for Browser Cookies. For more information on how You can delete Flash Cookies, please read "Where can I change the settings for disabling, or deleting local shared objects?" available at <span style={{color:"red"}}>https://helpx.adobe.com/flash-player/kb/disable-local-shared-objects-flash.html#main_Where_can_I_change_the_settings_for_disabling__or_deleting_local_shared_objects_</span></li>
          <li><strong>Web Beacons.</strong> Certain sections of our Service and our emails may contain small electronic files known as web beacons (also referred to as clear gifs, pixel tags, and single-pixel gifs) that permit the Company, for example, to count users who have visited those pages or opened an email and for other related website statistics (for example, recording the popularity of a certain section and verifying system and server integrity).</li>
        </ul>
        <p>Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies remain on Your personal computer or mobile device when You go offline, while Session Cookies are deleted as soon as You close Your web browser. Learn more about cookies: What Are <span style={{color:"red"}}>Cookies?.</span> </p>
        ...
        <div className={styles.personalDataUsage}>
            ...
            <ul>
              <li>By visiting this page on our website:<span style={{color:"red"}}>https://onelearninghealthcare.com/get-fit/</span> </li>
            </ul>
        </div>
      </div>
    </div>
